...
public class Treatement {
  ...
  public Object[][] detailTir(Connection con, String idJeu, int qt)
    throws Exception {
    boolean open = false;
    if (con == null) {
      try {
  ...
  public int getMarque(Connection con, int idPl, String idJeu, int qt)
    throws Exception {
    int pts = 0;
    try {
      Statement stat = con.createStatement();
  ...
  public int getPassD(Connection con, int idPl, String idJeu, int qt)
    throws Exception {
    int pts = 0;
    try {
      Statement stat = con.createStatement();
  ...
  public Object[][] getRebond(Connection con, String idJeu, int qt)
    throws Exception {
    boolean open = false;
    if (con == null) {
      try {
    ...
    try {
      ...
      ResultSet count = countStat.executeQuery(
        "SELECT count(*) from rebond WHERE rebond.idMatch='" +
        idJeu +
        "' and quart_tps='" +
        qt +
        "'"
  ...
  public int sumRebond(Connection con, int idPl, String idJeu, int qt)
    throws Exception {
    int pts = 0;
    try {
      Statement stat = con.createStatement();
  ...
  public int getduree(Connection con, int idPl, String idJeu, int qt)
    throws Exception {
    int pts = 0;
    try {
      Statement stat = con.createStatement();
  ...
  public int getdureeEquipe(Connection con, int equipe, String idJeu, int qt)
    throws Exception {
    int pts = 0;
    try {
      Statement stat = con.createStatement();
  ...
  public int[] getQuart(Connection con, String idJeu) throws Exception {
    boolean open = false;
    if (con == null) {
      try {
        con = psqlConnected();
    ...
    try {
      Statement stat = con.createStatement();
      String sql =
        "select distinct (quart_tps) from duree where idmatch='" +
        idJeu +
        "' and quart_tps!=0 order by quart_tps";

      System.out.println(sql);
      ResultSet rSet = stat.executeQuery(sql);
      Statement stat2 = con.createStatement();
      String sql2 =
        "select count(distinct (quart_tps)) from duree where idmatch='" +
        idJeu +
        "' and quart_tps!=0";
  ...
  public Object[][] getAllJoueur(Connection con, String idJeu) {
    boolean open = false;
    if (con == null) {
      try {
        con = psqlConnected();
    ...
    try {
      Statement stat = con.createStatement();
      String sql = "select * from joueur where idMatch='" + idJeu + "'";
      System.out.println(sql);
      ResultSet res = stat.executeQuery(sql);

      Statement countStat = con.createStatement();
      ResultSet count = countStat.executeQuery(
        "SELECT count(*) from joueur where idMatch='" + idJeu + "'"
      );
  ...
  public int getPoints(Connection con, int idPl, String idJeu, int qt)
    throws Exception {
    boolean open = false;
    if (con == null) {
      try {
    ...
    try {
      Statement stat = con.createStatement();
      String sql =
        "select sum(point) from tir  WHERE idMatch='" +
        idJeu +
        "' and idP='" +
        idPl +
        "' and quart_tps='" +
  ...
  public int getTentativeTir(Connection con, int idPl, String idJeu, int qt)
    throws Exception {
    boolean open = false;
    if (con == null) {
      try {
    ...
    try {
      Statement stat = con.createStatement();
      String sql =
        "select count(point) from tir  WHERE idMatch='" +
        idJeu +
        "' and idP='" +
        idPl +
        "' and quart_tps='" +
  ...
  public int getdureeTotalQuart(Connection con, String idJeu, int qt)
    throws Exception {
    boolean open = false;
    if (con == null) {
      try {
  ...
  public Object[][] getBestShooter(Connection con, String idJeu, int qt) {
    boolean open = false;
    if (con == null) {
      try {
        con = psqlConnected();
    ...
    try {
      Statement stat = con.createStatement();
      String sql =
        "select joueur.name,tir.idp,max(bestshooter.count) from tir join bestshooter on tir.idp = bestshooter.idp join joueur on tir.idp = joueur.id where tir.quart_tps = '" +
        qt +
        "' and idMatch='" +
        idJeu +
        "' group by joueur.name,tir.idp";
      System.out.println(sql);
      ResultSet res = stat.executeQuery(sql);
  ...
  public Object[][] getBestDribleur(Connection con, String idJeu, int qt) {
    boolean open = false;
    if (con == null) {
      try {
        con = psqlConnected();
    ...
    try {
      Statement stat = con.createStatement();
      String sql =
        "select joueur.name,idp,sum(duree.duree) from duree  WHERE idMatch='" +
        idJeu +
        "' and quart_tps='" +
        qt +
        "' group by joueur.name,idp order by sum desc";
      System.out.println(sql);
      ResultSet res = stat.executeQuery(sql);

      Statement countStat = con.createStatement();
      ResultSet count = countStat.executeQuery(
        "select count(idp) from dribleur"
      );
